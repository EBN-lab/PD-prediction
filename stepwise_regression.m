function results_stepwise=stepwise_regression(x,y)
% This function evaluates the results of kfold cross validation using the stepwise regression model 
...
% % Outputs
% % results_stepwise = structure that containes MAE, RMSE, R2, corr, pvalue
...
for leftout = 1:kfolds
    ...
    % Train 
    [b] = stepwisefit(x_train',y_train)

    % Test 
        y_predict(testinds)=b'* x_test ;

end
%% Assess performance
results_stepwise=assesment(y_predict,y)
