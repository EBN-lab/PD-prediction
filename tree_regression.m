function result_tree=tree_regression(x,y)

% This function evaluates the results of kfold cross validation using the tree regression model 
...
% % Outputs
% % results_tree = structure that containes MAE, RMSE, R2, corr, pvalue
...
%% Assess performance
result_tree=assesment(y_predict,y)
